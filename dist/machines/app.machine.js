...
export const AppMachine = createMachine({
    ...
    services: {
        connect_mongodb: (context, event, { src }) => __awaiter(void 0, void 0, void 0, function* () { return yield connect_mongodb(context, event, src); }),
        connect_redis: (context, event, { src }) => __awaiter(void 0, void 0, void 0, function* () { return yield connect_redis(context, event, src); }),
        create_http: (context, event, { src }) => __awaiter(void 0, void 0, void 0, function* () { return yield create_http(context, event, src); }),
        initialize_socket: (context, event, { src }) => __awaiter(void 0, void 0, void 0, function* () { return yield initialize_socket(context, event, src); })
    }
});
